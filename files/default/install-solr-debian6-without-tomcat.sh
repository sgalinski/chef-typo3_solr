...
GITRANCH_PATH="solr_$EXT_SOLR_VER.x"
...
wgetresource ()
{
	...
	then
		RESOURCE="https://forge.typo3.org/projects/extension-solr/repository/revisions/$GITBRANCH_PATH/raw/resources/"$1
	else
		RESOURCE="https://forge.typo3.org/projects/extension-solr/repository/revisions/master/raw/resources/"$1
	fi
...
#wget --progress=bar:force http://www.typo3-solr.com/fileadmin/files/apache-solr-$SOLR_VER.zip 2>&1 | progressfilt
...
cp apache-solr-$SOLR_VER/dist/apache-solr-$SOLR_VER.war /var/lib/tomcat6/webapps/solr.war
...
chown -R tomcat6 /opt/solr-tomcat/solr/typo3cores
